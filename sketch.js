...
function setup() {
	...
	box2 = createSprite(width-290,height-90,20,100)
	box2.shapeColor=color("red");

	box3 = createSprite(width-490,height-90,20,100)
	...
	ground = Bodies.rectangle(width/2, 650, width, 10 );
	 ...
	 box2 = Bodies.rectangle(width-290,height-90,20,100 );
	 World.add(world, box2);
	 
	 box3 = Bodies.rectangle(width-490,height-90,20,100 );
